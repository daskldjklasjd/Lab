...
public class MJSONObject extends JSONObject {
	 ...
	 * @return
	 */
	public Object setErrorCode(ErrorCode errorCode) {
		return put(Consts.ERROR_LABEL, errorCode.getDescription());
	}
	...
	public Object setResult(String result) {
		return put(Consts.RESULT_LABEL, result);
	}
	...
	public Object setDetail(JSONObject detail) {
		return put(Consts.DETAIL_LABEL, detail);
	}
	...
	public Object setPageInfo(@SuppressWarnings("rawtypes") PageInfo pageInfo) {
		...
		page.put(Consts.PAGE_HAVE_NEXT_PAGE, pageInfo.isHasNextPage());
