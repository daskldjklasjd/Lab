...
<script type="text/javascript" src="<%=bp%>/js/login.js"></script>

<link rel="stylesheet" type="text/css" href="<%=bp%>/css/bootstrap.min.css" />
...
<div class="box">
		<div class="login-box">
			...
			<div class="form">
            <p id="loginErrorMsg" class="text-center text-danger"></p>
			<form action="#" method="post">
				<div name="account" class="form-group">
					<div class="col-xs-12 ">
				...
				<div class="form-group form-actions">
					<div class="col-xs-4 col-xs-offset-4 ">
						<span id="login" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-off"></span> 登录</span>
					</div>
				</div>
			</form>
			</div>
